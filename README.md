...
| 채수범 | 황서영 | 김성한 | 김혜민 |
| --- | --- | --- | --- |
| ddd | - 팀원 간 커뮤니케이션 조율 <br> - 업무 분배 및 일정 관리 <br> - 판매자 앱 전체 디자인 <br> - 판매자 요구사항 설계 및 작성 <br> - 판매자 로그인/메인/장바구니/결제 화면 구성 <br> - Authentication을 통한 회원가입 및 로그인 기능 구현 <br> - Firestore 연동을 통해 상품 데이터 조회 및 RecyclerView 연동 기능 구현 <br>  |  |  |
|  |  |  |  |
